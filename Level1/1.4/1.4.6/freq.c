...
// freq.c for HW 1.4, Exercise 6
// This program takes in user input and when an escape signal is sent
// tells the user how many 0s, 1s, 2s, 3s, 4s, and other chars have been enetered
//
