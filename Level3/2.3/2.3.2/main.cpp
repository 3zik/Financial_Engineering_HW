// EFurman 6/6/2026
// main.cpp file for the Point class -- UPDATED FOR Exercise 2.3.2
// In this case, we have made the Distance() function take input via const reference rather than passing by value, which changes its function
// It is a more memory efficient implementation because we don't have to make as many copies of the same object
