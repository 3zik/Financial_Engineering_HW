// EFurman 6/6/26
// point class source file UPDATED for exercise 2.3.1 
// Includes the code for the destructor, constructor, getters/setters, private member vars, and toString fn for Point class.
// Here we have updated the code by adding in output when the default ctor and default dtor are called
// i also added the copy constructor to this file and a ctor that can take in non-default coordinate values
#include "point.hpp"
#include <sstream> 
