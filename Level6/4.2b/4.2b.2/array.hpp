...
namespace Ethan::Containers {
	...
	private:
		...
		static size_t s_defaultSize; // one of these is instnatited per definition of Array<T>
	...
	public:
		...
		static size_t DefaultSize(); // getter 

		static void DefaultSize(size_t size); // setter
	};
