...
// For Exercise 2.4.3, I am adding and testing a new ctor that takes in 1 double as input 
...
Point::Point(const double& x) : m_x(x), m_y(x){} // takes in 1 double, and then assigns both m_x and m_y to that value
