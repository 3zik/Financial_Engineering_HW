...
// For Exercise 2.4.3, I am adding a new ctor that takes in 1 double and testing it 
...
public:
	...
	// special ctor that takes in one double and assigns both m_x and m_y to that input 
