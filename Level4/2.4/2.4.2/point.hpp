...
// For Exercise 2.4.2, I add the ostream operator to the Point class
...
std::ostream& operator<<(std::ostream& os, const Point& p); // must define ostream outside the class
